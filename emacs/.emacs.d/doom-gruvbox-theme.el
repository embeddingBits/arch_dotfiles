...
(def-doom-theme doom-gruvbox
  ...
  ((bg
   ...
   (bg-alt
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#1d2021" "black" nil))     ; (self-defined)
          ((equal doom-gruvbox-dark-variant "soft") '("#282828" "#282828" nil))   ; bg0
          (t                                        '("#1d2021" "#1e1e1e" nil)))) ; bg_h
   (bg-alt2    '("#45403d" "#45403d" "brown"      )) ; bg_visual

   (base0      '("#1d2021" "black"   "black"      ))
   (base1      '("#1d2021" "#1d1d1d" "brightblack"))
   (base2      '("#282828" "#282828" "brightblack"))
   (base3      '("#3c3836" "#383838" "brightblack"))
   (base4      '("#5a524c" "#5c5c5c" "brightblack")) ; bg3 — warmer
   (base5      '("#7c6f64" "#6f6f6f" "brightblack"))
   (base6      '("#9da9a0" "#909090" "brightblack")) ; grey2 — material cool grey
   (base7      '("#d4be98" "#cccccc" "brightblack")) ; fg2
   (base8      '("#e2cca9" "#e2e2e2" "brightwhite")) ; fg0
   (fg         '("#d4be98" "#d4d4d4" "brightwhite")) ; fg — material's softer parchment
   (fg-alt     '("#c5b18b" "#c5c5c5" "brightwhite")) ; fg2

   ;; Gruvbox Material accent palette
   (grey        '("#928374" "#909090" "brightblack"))   ; grey
   (red         '("#ea6962" "#e06c75" "red"))           ; material red
   (magenta     '("#d3869b" "#d3869b" "magenta"))       ; material purple
   (violet      '("#d3869b" "#d3869b" "brightmagenta")) ; material purple
   (orange      '("#e78a4e" "#e78a4e" "orange"))        ; material orange
   (yellow      '("#d8a657" "#d8a657" "yellow"))        ; material yellow
   (dark-yellow '("#c08f3b" "#c08f3b" "yellow"))        ; material dark yellow
   (teal        '("#89b482" "#89b482" "green"))         ; material aqua
   (green       '("#a9b665" "#a9b665" "green"))         ; material green
   (dark-green  '("#8f9a52" "#8f9a52" "green"))         ; material dark green
   (blue        '("#7daea3" "#7daea3" "brightblue"))    ; material blue
   (dark-blue   '("#5a8a80" "#5a8a80" "blue"))          ; material dark blue
   (cyan        '("#89b482" "#89b482" "brightcyan"))    ; material aqua
   (my-black    '("#32302f" "#32302f" "black"))
   (dark-cyan   '("#6b9970" "#6b9970" "cyan"))          ; material dark aqua
