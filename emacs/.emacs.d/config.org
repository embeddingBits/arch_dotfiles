...
*** Font Configuration
#+begin_src emacs-lisp
(defvar +font "JetBrainsMono NFP")

(set-face-attribute 'default nil 
                    :font +font :height 130 :weight 'regular)
(set-face-attribute 'fixed-pitch nil 
                    :font +font :height 130)
...
(use-package org-roam
  ...
  (org-roam-capture-templates
   '(("c" "Concept" plain
      "#+title: ${title}\n#+created: %<%d-%m-%Y %a %H:%M>\n#+filetags: ${subject} roam_note concept\n\n"
      :if-new (file+head "fleet/${subject}/%<%d-%m-%Y-%H%M>-${slug}.org" "#+title: ${title}\n")
      :unnarrowed t)

     ("i" "Index / MOC" plain
      "#+title: ${title} – Index / Map of Content\n#+created: %<%d-%m-%Y %a %H:%M>\n#+filetags: ${subject} index moc\n\n"
      :if-new (file+head "fleet/${subject}/000-${slug}-index.org" "#+title: ${title}\n")
      :unnarrowed t)

     ("q" "Question / Problem" entry
      "* TODO %^{Problem description}\n:PROPERTIES:\n:Source: %^{From lecture/book?/year}\n:Marks: %^{Marks?}\n:END:\n\n** Attempt\n\n** Solution\n\n** Key Insight\n"
      :target (file+head "fleet/${subject}/${subject}-questions.org" "#+title: ${subject} – Questions & Problems")
      :prepend t)

     ("d" "Default" plain "%?"
      :if-new (file+head "%<%d-%m-%Y-%H%M>-${slug}.org" "#+title: ${title}\n")
      :unnarrowed t)))
