...
*** Font Configuration
#+begin_src emacs-lisp
  (defvar +font "JetBrainsMono Nerd Font Propo")
...
;; This ensures icons for dired and completion only load if the fonts are present
...
(use-package treesit-auto
  :custom
  (treesit-auto-install 'prompt) ; Or t for fully automatic
  :config
  (setq treesit-language-source-alist
        '((zig "https://github.com/tree-sitter-grammars/tree-sitter-zig")
          (typst "https://github.com/uben0/tree-sitter-typst")
  ...
  (let ((activity
         (if elcord-display-buffer-details
             (if (derived-mode-p 'pdf-view-mode)
                 ;; PDF: show filename in details, page number in state
                 (list
