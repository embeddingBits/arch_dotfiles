...
#+begin_src emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-footer-icon
          (nerd-icons-codicon "nf-cod-calendar"
                              :height 1.1
                              :v-adjust -0.05
...
*** Font Configuration
#+begin_src emacs-lisp
  (defvar +font "JetBrainsMono Nerd Font")
...
#+begin_src emacs-lisp
  ...
  (use-package vertico-posframe
    ...
    (setq vertico-posframe-poshandler #'posframe-poshandler-frame-center ; Position
          vertico-posframe-width 100                                       ; Width
