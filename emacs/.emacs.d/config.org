...
#+begin_src emacs-lisp
  (use-package doom-modeline
    ...
    ;; Fixed standard face customization syntax
    (custom-set-faces
...
#+begin_src emacs-lisp
  ...
  (use-package vertico-posframe
    ...
    (setq vertico-posframe-poshandler #'posframe-poshandler-frame-center ; Position
          vertico-posframe-width 150                                       ; Width
          vertico-posframe-height 12                                       ; Max height
          vertico-posframe-border-width 2                                  ; Border thickness
          vertico-posframe-fallback-mode vertico-buffer-mode))             ; Fallback if posframe fails
